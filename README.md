...
### ✅ Спринт 4
- Настроено тестирование с помощью Jest и Testing Library.
- Добавлены юнит-тесты для:
- Router (маршрутизация и рендеринг страниц)
- Block (базовый класс компонентов)
- HTTPTransport (модуль отправки запросов)
- Подключен Husky:
- Запуск линтера и тестов в pre-commit.
- Исправлены ошибки с окружением jest-environment-jsdom.
- Реализована проверка корректности работы компонентов при рендеринге и обновлении props.
